@php
    $styles = [
        ...
        'Online'         => ['bg' => '#ECFDF5', 'fg' => '#065F46', 'dot' => '#10B981', 'pulse' => true],
        'Warning'        => ['bg' => '#FFFBEB', 'fg' => '#92400E', 'dot' => '#F59E0B', 'pulse' => true],
        'Offline'        => ['bg' => '#FEF2F2', 'fg' => '#991B1B', 'dot' => '#EF4444', 'pulse' => false],
        'Maintenance'    => ['bg' => '#EFF6FF', 'fg' => '#1E40AF', 'dot' => '#3B82F6', 'pulse' => true],
        'Open'           => ['bg' => '#FFFBEB', 'fg' => '#92400E', 'dot' => '#F59E0B', 'pulse' => false],
        'Resolved'       => ['bg' => '#ECFDF5', 'fg' => '#065F46', 'dot' => '#10B981', 'pulse' => false],
        'Closed'         => ['bg' => '#F1F5F9', 'fg' => '#334155', 'dot' => '#64748B', 'pulse' => false],
    ];
