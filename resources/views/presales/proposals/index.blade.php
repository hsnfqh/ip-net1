                                            ...
                                            <div class="flex items-center justify-end gap-1.5">
                                                @if($p->proposal_file)
                                                    <a href="{{ route('presales.proposals.download', $p->id) }}" 
                                                       ...
                                                       class="px-2.5 py-1 text-[11px] font-bold text-[#8F0A0D] bg-[#8F0A0D]/10 hover:bg-[#8F0A0D] hover:text-white rounded-lg transition shadow-2xs inline-flex items-center gap-1">
