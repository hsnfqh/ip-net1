                ...
                <div class="jkw-card">
                    ...
                    <div class="jkw-day-list">
                        ...
                        <div class="jkw-empty" x-show="daySchedules.length === 0" style="padding:48px 16px 56px; text-align:center;">
                            ...
                            <p style="margin-bottom:0; font-size:13.5px; color:#75727C;">Tidak ada jadwal atau agenda pada hari ini.</p>
                            @if($canManageSchedule ?? false)
                                                ...
                                                <template x-for="(session, sIdx) in (form.sessions || [])" :key="sIdx">
                                                    <div style="background:#F8FAFC; border:1.5px solid #E2E8F0; border-radius:10px; padding:16px 18px; position:relative; display:flex; flex-direction:column; gap:16px; transition:all 0.15s ease;">
                                                        ...
                                                        <div x-show="!editing && form.sessions && form.sessions.length > 1" style="display:flex; align-items:center; justify-content:space-between; padding-bottom:10px; border-bottom:1px solid #E2E8F0;">
                                                            ...
                                                            <button type="button" @click="removeSession(sIdx)" style="background:none; border:none; color:#EF4444; font-size:11px; font-weight:700; cursor:pointer; display:inline-flex; align-items:center; gap:4px; padding:2px 6px; border-radius:6px;" onmouseover="this.style.background='#FEE2E2'" onmouseout="this.style.background='none'">
