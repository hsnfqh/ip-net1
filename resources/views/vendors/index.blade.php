    ...
    <template x-teleport="body">
        <div x-show="deleteConfirmOpen" 
            ...
            <div class="bg-white rounded-2xl w-[420px] max-w-full p-6 text-left shadow-[0_20px_60px_rgba(15,23,42,0.25)] animate-fade-in-up border border-[#E2E8F0]">
                ...
                <p class="text-center text-[12.5px] text-[#64748B] mb-6 break-words" x-text="'Vendor &quot;' + (vendorToDelete ? vendorToDelete.name : '') + '&quot; akan dihapus secara permanen.'"></p>

                <form :action="`/vendors/${vendorToDelete ? vendorToDelete.id : ''}`" method="POST" class="flex gap-2.5">
                    @csrf
                    @method('DELETE')
    ...
    function vendorManagerPage() {
        return {
            ...
            confirmDelete(id, name) {
                this.vendorToDelete = { id: id, name: name };
